    ...
    return (
        <div className="relative">
            ...
            <label htmlFor="interrogante" className="block mb-1 font-semibold ">
                ESCRIBA O SELECCIONE LA INTERROGANTE A UTILIZAR EN<span className='text-red-500'>PREGUNTA SECUNDARIA 2</span>:  <span className="text-xl font-bold text-gray-500">I</span>
            </label>
