...
export default function VerbosMiic3({ dataform }: { dataform: ResultadoMIIC }) {
    ...
    return (
        <div className="relative">
            ...
            <label htmlFor="verbo" className="block mb-1 font-semibold">
                ESCRIBA O SELECCIONE EL VERBO A UTILIZAR EN<span className='text-red-500'>OBJETIVO ESPECIFICO 3</span>:  <span className="text-xl font-bold text-gray-500">V</span>
            </label>
            ...
            <input
                ...
                name="v2"
                value={value2?value2:dataform.o3}
